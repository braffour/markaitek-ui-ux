    ...
    if (status === 'idle') {
        return (
            <div className="h-full flex flex-col items-center justify-center px-8 py-12 text-center">
                ...
                <h3 className="text-[15px] font-bold text-slate-900 dark:text-slate-100 mb-2">No runs yet</h3>
                <p className="text-[12px] text-slate-500 dark:text-slate-400 leading-relaxed mb-8">
                    Start a workflow to see execution details, logs, and potential errors here.
                </p>
                ...
                <p className="mt-8 text-[11px] text-slate-400 font-medium italic">
                    Hint: Runs and errors will appear here.
                </p>
            </div>
        );
    }
        ...
        <div className="pb-12">
            ...
            <div className="px-6 mb-8">
                {status === 'running' && (
                    <div className="p-4 bg-indigo-50/50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-900/30 rounded-2xl">
                        <div className="flex items-center justify-between mb-3">
                            <span className="text-[11px] font-bold text-indigo-900 dark:text-indigo-200 uppercase tracking-widest">Now Running</span>
                            <span className="text-[11px] font-bold text-indigo-500">Step 3 of {steps.length}</span>
                        </div>
                ...
                {status === 'success' && (
                    <div className="p-4 bg-emerald-50/50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-900/30 rounded-2xl text-center">
                        ...
                        <h3 className="text-[15px] font-bold text-slate-900 dark:text-slate-100 mb-1">Run completed</h3>
                        <p className="text-[11px] text-slate-500 dark:text-slate-400 mb-4">Total duration: 1.4s • 5/5 steps passed</p>
                ...
                <>
                    <ErrorBanner
                        error={{
                            ...
                            message: "Connection timeout while calling Enrichment API.",
                            code: "ERR_TIMEOUT",
                            details: "The resource at 'https://api.enrichment.cloud' failed to respond within 5000ms. Retrying with longer timeout might help."
                        }}
                        onRetry={onRun}
                        onDebug={onDebug}
                    />
            ...
            <div className="relative">
                <div className="px-6 mb-4 flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-bold text-slate-400 bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded uppercase">{steps.length} Steps</span>
                </div>
